    ...
    public class ViewingAdsYG : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!start && !isPause)
            {
                ...
                cursorVisibleOnAd = UnityEngine.Cursor.visible;
                cursorLockModeOnAd = UnityEngine.Cursor.lockState;
            }
        }
                ...
                if (pauseType == PauseType.CursorActivity || pauseType == PauseType.All)
                {
                    ...
                    else
                    {
                        if (pauseMethod == PauseMethod.CustomState)
                        {
                            ...
                            else UnityEngine.Cursor.visible = true;

                            UnityEngine.Cursor.lockState = closingADValues.cursorLockMode;
                        }
                        else
                        {
                            UnityEngine.Cursor.visible = cursorVisibleOnAd;
                            UnityEngine.Cursor.lockState = cursorLockModeOnAd;
                        }
                    }
                }
            }
